...
CREATE TABLE `FlightInstance` (
  ...
  FOREIGN KEY (`FLNO`) REFERENCES Flight (`FLNO`) ON DELETE CASCADE ON UPDATE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `PlaneSeats` (
  ...
  FOREIGN KEY (`Maker`, `Model`) REFERENCES PlaneType (`Maker`, `Model`) ON DELETE CASCADE ON UPDATE CASCADE 
  ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `Reservation` (
  ...
  FOREIGN KEY (`PassID`) REFERENCES Passenger ( `ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`FLNO`, `FDate`) REFERENCES FlightInstance (`FLNO`, `FDate`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`FromA`) REFERENCES Airport (`Code`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`ToA`) REFERENCES Airport (`Code`) ON DELETE CASCADE ON UPDATE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `Plane` (
  ...
  PRIMARY KEY (`ID`),
  FOREIGN KEY (`Maker`, `Model`) REFERENCES PlaneType (`Maker`, `Model`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`LastMaintA`) REFERENCES Airport (`Code`) ON DELETE CASCADE ON UPDATE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `FlightLeg` (
  ...
  FOREIGN KEY (`FromA`) REFERENCES Airport (`Code`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`ToA`) REFERENCES Airport (`Code`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`Plane`) REFERENCES Plane (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `FlightLegInstance` (
  ...
  FOREIGN KEY (`FLNO`, `Seq`) REFERENCES FlightLeg (`FLNO`, `Seq` )ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`FLNO`, `FDate`) REFERENCES FlightInstance (`FLNO`, `FDate`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`Pilot`) REFERENCES Pilot (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
